...
bool AreEntityListsEqual(const std::list<std::tuple<EntityEnum, std::string>> &l1, const std::vector<Entity*>& l2);
bool AreAllPairsEqual(const std::list<std::tuple<std::tuple<EntityEnum, std::string>,
