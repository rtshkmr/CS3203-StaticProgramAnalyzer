...
TEST_CASE("1.EntityFactory.CreateEntities") {
  ...
  SECTION("procedure test") {
    ...
    Entity* actual_procedure_entity = entity_factory.CreateEntities(procedure_tokens, ent);
...
//    CHECK(actual_procedure_entity == duplicate_proc);
  ...
  SECTION("read test") {
    ...
    Entity* actual_read_entity = entity_factory.CreateEntities(read_tokens, ent);
    ...
    Entity* duplicate_read = entity_factory.CreateEntities(read_tokens, ent);
  ...
  SECTION("print test") {
    ...
    Entity* actual_print_entity = entity_factory.CreateEntities(print_tokens, ent);
    ...
    Entity* duplicate_print = entity_factory.CreateEntities(print_tokens, ent);
  ...
  SECTION("call test") {
    ...
    Entity* actual_call_entity = entity_factory.CreateEntities(call_tokens, ent);
    ...
    Entity* duplicate_call = entity_factory.CreateEntities(call_tokens, ent);
  ...
  SECTION("ass test") {
    ...
    Entity* actual_assign_entity = entity_factory.CreateEntities(assign_tokens, ent);
    ...
    Entity* duplicate_ass = entity_factory.CreateEntities(assign_tokens, ent);
  ...
  SECTION("while test") {
    ...
    Entity* actual_while_entity = entity_factory.CreateEntities(while_tokens, ent);
  ...
  SECTION("if test") {
    ...
    Entity* actual_if_entity = entity_factory.CreateEntities(if_tokens, ent);
  ...
  SECTION("else test") {
    ...
    CHECK(dynamic_cast<ElseEntity*>(entity_factory.CreateEntities(else_tokens, ent)));
  }
  ...
  SECTION("negative test") {
    ...
    CHECK_THROWS_AS(entity_factory.CreateEntities(wrong_keyword_tokens, ent), std::invalid_argument);
  }
}
